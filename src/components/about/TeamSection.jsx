...
//           <p className="max-w-2xl mx-auto text-slate-300">Meet the innovative minds behind Connecting Dots Innovations, driving our vision and technical excellence.</p>
//         </div>
...
const GlassCard = ({ children, className = "" }) => (
  <div
    className={`backdrop-blur-lg bg-white/10 rounded-2xl border border-white/20 shadow-xl p-6 hover:bg-white/20 transition-all duration-500 ${className}`}
  >
    {children}
  </div>
);
  ...
  const teamMembers = [
    {
      ...
      instagramUrl:
        "https://www.instagram.com/akshat1908?igsh=aWR5aDN1OGsyY3h2",
    },
    {
      name: "Ishan Jain",
      role: "CTO",
      ...
      instagramUrl:
        "https://www.instagram.com/__ishan05?igsh=MTJuZjdtbzh0aXVkZw%3D%3D&utm_source=qr",
    },
    {
      name: "Bhavya Kothari",
      role: "Lead Developer",
      ...
      instagramUrl:
        "https://www.instagram.com/bhavya_593?igsh=eXU0aWthNjdmdjRl",
    },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-slate-300">
            Meet the innovative minds behind Connecting Dots Innovations,
            driving our vision and technical excellence.
          </p>
        </div>
