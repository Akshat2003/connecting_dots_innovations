...
//                   <span className="text-white font-medium">Connecting Dots Innovations HQ</span>
//                 </div>
//               </div>
//             </div>
//           </div>
...
const ContactMap = () => {
  return (
    <section className="py-16 relative">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 inline-block bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-purple-400">
            Visit Our Office
          </h2>
          <p className="max-w-2xl mx-auto text-slate-300">
            Located in the heart of India, Indore - Madhya Pradesh
          </p>
        </div>
      </div>
      ...
      <div className="relative rounded-xl overflow-hidden mx-auto max-w-6xl shadow-xl">
        ...
        <div className="w-full h-96 md:h-[450px]">
          <iframe
            ...
            title="Connecting Dots Innovations Office Location"
          ></iframe>
        </div>
          ...
          <div className="px-6 py-3 bg-indigo-800/80 backdrop-blur-md rounded-lg border border-indigo-500/30 shadow-xl">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-medium">
                Connecting Dots Innovations HQ
              </span>
            </div>
          </div>
        </div>
